export default function Page() {
  return (
    <>
      ...
      <h1>Shadows</h1>
      <div>
        <div className="max-w-lg my-6 mx-auto shadow">
        ...
        <div className="max-w-lg my-6 mx-auto shadow-md">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate
          mollitia asperiores ullam culpa hic omnis optio, animi, magni incidunt
          nobis dolorum excepturi id suscipit. Ea hic natus placeat veritatis
          quisquam?
        </div>
        <div className="max-w-lg my-6 mx-auto shadow-lg">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate
          mollitia asperiores ullam culpa hic omnis optio, animi, magni incidunt
          nobis dolorum excepturi id suscipit. Ea hic natus placeat veritatis
          quisquam?
        </div>
        <div className="max-w-lg my-6 mx-auto shadow-xl shadow-blue-500/50">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate
          mollitia asperiores ullam culpa hic omnis optio, animi, magni incidunt
          nobis dolorum excepturi id suscipit. Ea hic natus placeat veritatis
          quisquam?
        </div>
        <div className="max-w-lg my-6 mx-auto shadow-xl shadow-red-500/50">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate
          mollitia asperiores ullam culpa hic omnis optio, animi, magni incidunt
          nobis dolorum excepturi id suscipit. Ea hic natus placeat veritatis
          quisquam?
